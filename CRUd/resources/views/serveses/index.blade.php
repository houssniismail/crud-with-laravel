...
@section('content')
    ...
    <div class="w-[80vw] ml-auto mr-auto ">
        <button class=" rounded bg-green-600 p-4 top-8"><a href="{{url('serves/create')}}">Add New serves</a></button>
    </div>
    <div> 
        <table class="ml-auto mr-auto w-[80vw] border">
            ...
            <tbody>
                @foreach ($serveses as $item)
                <tr>
                    <td class="text-center">{{$item['id']}}</td>
                    <td class="text-center">{{$item['name']}}</td>
                    <td class="text-center">{{$item['image']}}</td>
                    <td class="text-center">{{$item['name_of_create	']}}</td>
                    <td class="text-center">{{$item['category']}}</td>
                    <td class="text-center">{{$item['date_creation']}}</td>
